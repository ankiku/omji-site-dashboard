...
export const MODULE_CATEGORIES = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'payments', label: 'Client Payment', icon: '💳', description: 'Invoices & Client Draws' },
      { id: 'vendor-payments', label: 'Omji Construction Payment', icon: '🧾', description: 'Track vendor & sub payments' },
    ],
  },
  {
    id: 'resources',
