...
export async function getPublicExpenses(slug) {
  const res = await fetch(`${API_URL}/public/projects/slug/${slug}/expenses`);
  if (!res.ok) return [];
  return res.json();
}

export async function getPublicPayments(slug) {
  const res = await fetch(`${API_URL}/public/projects/slug/${slug}/payments`);
  if (!res.ok) return [];
  return res.json();
}

export async function getPublicContacts(slug) {
  const res = await fetch(`${API_URL}/public/projects/slug/${slug}/contacts`);
  if (!res.ok) return [];
  return res.json();
}

export async function getPublicMaterials(slug) {
  const res = await fetch(`${API_URL}/public/projects/slug/${slug}/materials`);
  if (!res.ok) return [];
  return res.json();
}
...
export async function deletePhotoRecord(projectId, photoId) {
